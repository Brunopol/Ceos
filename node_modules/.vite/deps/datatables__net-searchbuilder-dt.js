...
} from "./chunk-U3HWLZY7.js";
import {
  jquery_dataTables_default
} from "./chunk-ZOOYZR54.js";
import {
  require_jquery
} from "./chunk-SOGVBVK2.js";
import {
  __toESM
} from "./chunk-UXIASGQL.js";

// node_modules/datatables.net-searchbuilder-dt/js/searchBuilder.dataTables.mjs
var import_jquery2 = __toESM(require_jquery(), 1);

// node_modules/datatables.net-searchbuilder/js/dataTables.searchBuilder.mjs
...
(function() {
  ...
  var Criteria = (
    /** @class */
    function() {
      function Criteria2(table, opts, topGroup, index, depth, serverData) {
        var _this = this;
        if (index === void 0) {
          index = 0;
        }
        ...
        this.classes = $$3.extend(true, {}, Criteria2.classes);
        this.c = $$3.extend(true, {}, Criteria2.defaults, $$3.fn.dataTable.ext.searchBuilder, opts);
        ...
        this.dom = {
          ...
          value: [
            $$3("<select disabled/>").addClass(this.classes.value).addClass(this.classes.dropDown).addClass(this.classes.italic).addClass(this.classes.select)
          ],
      ...
      Criteria2._escapeHTML = function(txt) {
        return txt.toString().replace(/&amp;/g, "&").replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&quot;/g, '"');
      };
      Criteria2.parseNumFmt = function(val) {
        return +val.replace(/(?!^-)[^0-9.]/g, "");
      };
      Criteria2.prototype.updateArrows = function(hasSiblings) {
      ...
      Criteria2.prototype.destroy = function() {
      ...
      Criteria2.prototype.search = function(rowData, rowIdx) {
        var condition = this.s.conditions[this.s.condition];
        if (this.s.condition !== void 0 && condition !== void 0) {
      ...
      Criteria2.prototype.getDetails = function(deFormatDates) {
        if (deFormatDates === void 0) {
          deFormatDates = false;
        }
        if (this.s.type !== null && this.s.type.includes("num") && (this.s.dt.settings()[0].oLanguage.sDecimal !== "" || this.s.dt.settings()[0].oLanguage.sThousands !== "")) {
        ...
        return {
          ...
          value: this.s.value.map(function(a) {
            return a !== null && a !== void 0 ? a.toString() : a;
          })
        };
      };
      Criteria2.prototype.getNode = function() {
        return this.dom.container;
      };
      Criteria2.prototype.populate = function() {
        this._populateData();
        if (this.s.dataIdx !== -1) {
      ...
      Criteria2.prototype.rebuild = function(loadedCriteria) {
        var foundData = false;
        var dataIdx;
        this._populateData();
        if (loadedCriteria.data !== void 0) {
        ...
        if (foundData) {
          ...
          for (var i = 0; i < options.length; i++) {
            ...
            if (loadedCriteria.condition !== void 0 && option.val() === loadedCriteria.condition && typeof loadedCriteria.condition === "string") {
      ...
      Criteria2.prototype.setListeners = function() {
        var _this = this;
          ...
          for (var i = 0; i < options.length; i++) {
            ...
            if (option.val() === _this.dom.condition.val()) {
              ...
              for (var _b = 0, _c = _this.dom.value; _b < _c.length; _b++) {
                var val = _c[_b];
                if (_this.s.filled && val !== void 0 && _this.dom.inputCont.has(val[0]).length !== 0) {
                  _this.s.filled = false;
                  _this.s.dt.draw();
                  _this.setListeners();
                }
              }
              if (_this.dom.value.length === 0 || _this.dom.value.length === 1 && _this.dom.value[0] === void 0) {
                _this.s.dt.draw();
              }
            } else {
              option.removeProp("selected");
      ...
      Criteria2.prototype.setupButtons = function() {
      ...
      Criteria2.prototype._buildCriteria = function() {
      ...
      Criteria2.prototype._clearCondition = function() {
      ...
      Criteria2.prototype._clearValue = function() {
        if (this.s.condition !== void 0) {
          ...
          this.dom.value = [].concat(this.s.conditions[this.s.condition].init(this, Criteria2.updateListener));
          if (this.dom.value.length > 0 && this.dom.value[0] !== void 0) {
        ...
        this.s.value = [];
        this.dom.value = [
          $$3("<select disabled/>").addClass(this.classes.value).addClass(this.classes.dropDown).addClass(this.classes.italic).addClass(this.classes.select).append(this.dom.valueTitle.clone())
        ];
      };
      Criteria2.prototype._getOptions = function() {
        var table = this.s.dt;
        return $$3.extend(true, {}, Criteria2.defaults, table.settings()[0].aoColumns[this.s.dataIdx].searchBuilder);
      };
      Criteria2.prototype._populateCondition = function() {
        var conditionOpts = [];
        ...
        if (conditionsLength === 0) {
          ...
          if (colInits !== void 0) {
            ...
            if (colInit.searchBuilderType !== void 0 && colInit.searchBuilderType !== null) {
              this.s.type = colInit.searchBuilderType;
            } else if (this.s.type === void 0 || this.s.type === null) {
              this.s.type = colInit.sType;
            }
          }
          if (this.s.type === null || this.s.type === void 0) {
          ...
          var conditionObj = this.c.conditions[this.s.type] !== void 0 ? this.c.conditions[this.s.type] : this.s.type.includes("moment") ? this.c.conditions.moment : this.s.type.includes("luxon") ? this.c.conditions.luxon : this.c.conditions.string;
          ...
          for (var _i = 0, _a = Object.keys(conditionObj); _i < _a.length; _i++) {
            ...
            if (conditionObj[condition] !== null) {
              if (this.s.dt.page.info().serverSide && conditionObj[condition].init === Criteria2.initSelect) {
                var col = colInits[column];
                if (this.s.serverData && this.s.serverData[col.data]) {
                  conditionObj[condition].init = Criteria2.initSelectSSP;
                  conditionObj[condition].inputValue = Criteria2.inputValueSelect;
                  conditionObj[condition].isInputValid = Criteria2.isInputValidSelect;
                } else {
                  conditionObj[condition].init = Criteria2.initInput;
                  conditionObj[condition].inputValue = Criteria2.inputValueInput;
                  conditionObj[condition].isInputValid = Criteria2.isInputValidInput;
                }
              }
          ...
          for (var _b = 0, _c = Object.keys(this.s.conditions); _b < _c.length; _b++) {
            ...
            if (this.s.condition !== void 0 && this.s.condition === condName) {
            ...
            for (var i = 0; i < conditionOpts.length; i++) {
              for (var _e = 0, _f = Object.keys(this.s.conditions); _e < _f.length; _e++) {
                ...
                if (
                  ...
                  (typeof condName === "string" ? condName : condName(this.s.dt, this.c.i18n)) === conditionOpts[i].text() && // and the tokens match
      ...
      Criteria2.prototype._populateData = function() {
      ...
      Criteria2.prototype._populateValue = function(loadedCriteria) {
        var _this = this;
        ...
        this.dom.value = [].concat(this.s.conditions[this.s.condition].init(this, Criteria2.updateListener, loadedCriteria !== void 0 ? loadedCriteria.value : void 0));
        if (loadedCriteria !== void 0 && loadedCriteria.value !== void 0) {
          this.s.value = loadedCriteria.value;
        }
        this.dom.inputCont.empty();
        if (this.dom.value[0] !== void 0) {
          this.dom.value[0].appendTo(this.dom.inputCont).trigger("dtsb-inserted");
        }
        for (var i = 1; i < this.dom.value.length; i++) {
      ...
      Criteria2.prototype._throttle = function(fn, frequency) {
        if (frequency === void 0) {
          frequency = 200;
        }
        var last = null;
      ...
      Criteria2.initSelect = function(that, fn, preDefined, array) {
        ...
        var el = $$3("<select/>").addClass(Criteria2.classes.value).addClass(Criteria2.classes.dropDown).addClass(Criteria2.classes.italic).addClass(Criteria2.classes.select).append(that.dom.valueTitle).on("change.dtsb", function() {
          $$3(this).removeClass(Criteria2.classes.italic);
          fn(that, this);
        });
        if (that.c.greyscale) {
          el.addClass(Criteria2.classes.greyscale);
        }
        var added = [];
        var options = [];
        for (var _i = 0, indexArray_1 = indexArray; _i < indexArray_1.length; _i++) {
          ...
          var addOption = function(filt, text) {
            ...
            var opt2 = $$3("<option>", {
              ...
              value: filt
            }).data("sbv", filt).addClass(that.classes.option).addClass(that.classes.notItalic).html(typeof text === "string" ? text.replace(/(<([^>]+)>)/ig, "") : text);
            var val = opt2.val();
            if (added.indexOf(val) === -1) {
              ...
              if (preDefined !== null && opt2.val() === preDefined[0]) {
                opt2.prop("selected", true);
                el.removeClass(Criteria2.classes.italic);
      ...
      Criteria2.initSelectSSP = function(that, fn, preDefined) {
        if (preDefined === void 0) {
          preDefined = null;
        }
        that.dom.valueTitle.prop("selected", true);
      ...
      Criteria2.initSelectArray = function(that, fn, preDefined) {
        if (preDefined === void 0) {
          preDefined = null;
        }
        return Criteria2.initSelect(that, fn, preDefined, true);
      };
      Criteria2.initInput = function(that, fn, preDefined) {
        if (preDefined === void 0) {
          preDefined = null;
        }
        var searchDelay = that.s.dt.settings()[0].searchDelay;
        var el = $$3("<input/>").addClass(Criteria2.classes.value).addClass(Criteria2.classes.input).on("input.dtsb keypress.dtsb", that._throttle(function(e) {
      ...
      Criteria2.init2Input = function(that, fn, preDefined) {
        if (preDefined === void 0) {
          preDefined = null;
        }
        var searchDelay = that.s.dt.settings()[0].searchDelay;
        var els = [
          $$3("<input/>").addClass(Criteria2.classes.value).addClass(Criteria2.classes.input).on("input.dtsb keypress.dtsb", that._throttle(function(e) {
            var code = e.keyCode || e.which;
            return fn(that, this, code);
          }, searchDelay === null ? 100 : searchDelay)),
        ...
        if (that.c.greyscale) {
          els[0].addClass(Criteria2.classes.greyscale);
          els[2].addClass(Criteria2.classes.greyscale);
        }
        if (preDefined !== null) {
      ...
      Criteria2.initDate = function(that, fn, preDefined) {
        if (preDefined === void 0) {
          preDefined = null;
        }
        var searchDelay = that.s.dt.settings()[0].searchDelay;
        var i18n = that.s.dt.i18n("datetime", {});
        var el = $$3("<input/>").addClass(Criteria2.classes.value).addClass(Criteria2.classes.input).dtDateTime({
          attachTo: "input",
          format: that.s.dateFormat ? that.s.dateFormat : void 0,
          i18n
      ...
      Criteria2.initNoValue = function(that) {
        that.s.dt.one("draw.dtsb", function() {
          that.s.topGroup.trigger("dtsb-redrawLogic");
        });
        return [];
      };
      Criteria2.init2Date = function(that, fn, preDefined) {
        var _this = this;
        if (preDefined === void 0) {
          preDefined = null;
        }
        ...
        var i18n = that.s.dt.i18n("datetime", {});
        var els = [
          $$3("<input/>").addClass(Criteria2.classes.value).addClass(Criteria2.classes.input).dtDateTime({
            attachTo: "input",
            format: that.s.dateFormat ? that.s.dateFormat : void 0,
            i18n
          }).on("change.dtsb", searchDelay !== null ? that.s.dt.settings()[0].oApi._fnThrottle(function() {
            return fn(that, this);
          ...
          $$3("<input/>").addClass(Criteria2.classes.value).addClass(Criteria2.classes.input).dtDateTime({
            ...
            fn(that, _this);
          }).on("input.dtsb keypress.dtsb", !that.c.enterSearch && !(that.s.dt.settings()[0].oInit.search !== void 0 && that.s.dt.settings()[0].oInit.search["return"]) && searchDelay !== null ? that.s.dt.settings()[0].oApi._fnThrottle(function() {
            return fn(that, this);
      ...
      Criteria2.isInputValidSelect = function(el) {
        var allFilled = true;
        for (var _i = 0, el_1 = el; _i < el_1.length; _i++) {
          var element = el_1[_i];
          if (element.children("option:selected").length === element.children("option").length - element.children("option." + Criteria2.classes.notItalic).length && element.children("option:selected").length === 1 && element.children("option:selected")[0] === element.children("option")[0]) {
            allFilled = false;
          }
        }
        return allFilled;
      };
      Criteria2.isInputValidInput = function(el) {
        var allFilled = true;
      ...
      Criteria2.inputValueSelect = function(el) {
        var values = [];
        for (var _i = 0, el_3 = el; _i < el_3.length; _i++) {
          var element = el_3[_i];
          if (element.is("select")) {
            values.push(Criteria2._escapeHTML(element.children("option:selected").data("sbv")));
          }
        }
        return values;
      };
      Criteria2.inputValueInput = function(el) {
        var values = [];
        for (var _i = 0, el_4 = el; _i < el_4.length; _i++) {
          var element = el_4[_i];
          if (element.is("input")) {
            values.push(Criteria2._escapeHTML(element.val()));
          }
        }
        return values;
      };
      Criteria2.updateListener = function(that, el, code) {
        var condition = that.s.conditions[that.s.condition];
        that.s.filled = condition.isInputValid(that.dom.value, that);
        that.s.value = condition.inputValue(that.dom.value, that);
        if (!that.s.filled) {
          if (!that.c.enterSearch && !(that.s.dt.settings()[0].oInit.search !== void 0 && that.s.dt.settings()[0].oInit.search["return"]) || code === 13) {
            that.s.dt.draw();
          }
          return;
        }
        ...
        for (var i = 0; i < that.s.value.length; i++) {
          if (Array.isArray(that.s.value[i])) {
            that.s.value[i].sort();
          } else if (that.s.type.includes("num") && (that.s.dt.settings()[0].oLanguage.sDecimal !== "" || that.s.dt.settings()[0].oLanguage.sThousands !== "")) {
      ...
      Criteria2.dateConditions = {
        "=": {
          conditionName: function(dt, i18n) {
            return dt.i18n("searchBuilder.conditions.date.equals", i18n.conditions.date.equals);
          },
          init: Criteria2.initDate,
          inputValue: Criteria2.inputValueInput,
          isInputValid: Criteria2.isInputValidInput,
      ...
      Criteria2.momentDateConditions = {
        "=": {
          conditionName: function(dt, i18n) {
            return dt.i18n("searchBuilder.conditions.date.equals", i18n.conditions.date.equals);
          },
      ...
      Criteria2.numConditions = {
        "=": {
          conditionName: function(dt, i18n) {
            return dt.i18n("searchBuilder.conditions.number.equals", i18n.conditions.number.equals);
          },
          init: Criteria2.initSelect,
          inputValue: Criteria2.inputValueSelect,
          isInputValid: Criteria2.isInputValidSelect,
          search: function(value, comparison) {
            return +value === +comparison[0];
          }
        },
      ...
      Criteria2.numFmtConditions = {
        "=": {
          ...
          isInputValid: Criteria2.isInputValidSelect,
          search: function(value, comparison) {
            return Criteria2.parseNumFmt(value) === Criteria2.parseNumFmt(comparison[0]);
          }
        },
        // eslint-disable-next-line sort-keys
        "!=": {
        ...
        "between": {
          ...
          isInputValid: Criteria2.isInputValidInput,
          search: function(value, comparison) {
            var val = Criteria2.parseNumFmt(value);
            var comp0 = Criteria2.parseNumFmt(comparison[0]);
            var comp1 = Criteria2.parseNumFmt(comparison[1]);
            if (+comp0 < +comp1) {
              return +comp0 <= +val && +val <= +comp1;
            } else {
              return +comp1 <= +val && +val <= +comp0;
      ...
      Criteria2.defaults = {
        columns: true,
        conditions: {
          "array": Criteria2.arrayConditions,
          "date": Criteria2.dateConditions,
          "html": Criteria2.stringConditions,
          "html-num": Criteria2.numConditions,
          "html-num-fmt": Criteria2.numFmtConditions,
          "luxon": Criteria2.luxonDateConditions,
          "moment": Criteria2.momentDateConditions,
          "num": Criteria2.numConditions,
          "num-fmt": Criteria2.numFmtConditions,
          "string": Criteria2.stringConditions
        },
        depthLimit: false,
        enterSearch: false,
  ...
  var Group = (
    /** @class */
    function() {
      function Group2(table, opts, topGroup, index, isChild, depth, serverData) {
        if (index === void 0) {
          index = 0;
        }
        if (isChild === void 0) {
        ...
        this.classes = $$2.extend(true, {}, Group2.classes);
        this.c = $$2.extend(true, {}, Group2.defaults, opts);
        this.s = {
          criteria: [],
          depth,
          dt: table,
      ...
      Group2.prototype.getDetails = function(deFormatDates) {
        if (deFormatDates === void 0) {
          deFormatDates = false;
        }
      ...
      Group2.prototype.getNode = function() {
        return this.dom.container;
      };
      Group2.prototype.rebuild = function(loadedDetails) {
        if (loadedDetails.criteria === void 0 || loadedDetails.criteria === null || Array.isArray(loadedDetails.criteria) && loadedDetails.criteria.length === 0) {
          return;
        }
        ...
        if (Array.isArray(loadedDetails.criteria)) {
          for (var _i = 0, _a = loadedDetails.criteria; _i < _a.length; _i++) {
            var crit = _a[_i];
            if (crit.logic !== void 0) {
              this._addPrevGroup(crit);
            } else if (crit.logic === void 0) {
      ...
      Group2.prototype.redrawContents = function() {
        ...
        for (var i = 0; i < this.s.criteria.length; i++) {
          ...
          } else if (crit instanceof Group2 && crit.s.criteria.length > 0) {
            this.s.criteria[i].index = i;
            this.s.criteria[i].criteria.s.index = i;
            this.s.criteria[i].criteria.dom.container.insertBefore(this.dom.add);
      ...
      Group2.prototype.redrawLogic = function() {
        for (var _i = 0, _a = this.s.criteria; _i < _a.length; _i++) {
          var crit = _a[_i];
          if (crit.criteria instanceof Group2) {
            crit.criteria.redrawLogic();
          }
        }
        this.setupLogic();
      };
      Group2.prototype.search = function(rowData, rowIdx) {
        if (this.s.logic === "AND") {
      ...
      Group2.prototype.setupLogic = function() {
      ...
      Group2.prototype.setListeners = function() {
        var _this = this;
      ...
      Group2.prototype.addCriteria = function(crit) {
        if (crit === void 0) {
          crit = null;
        }
      ...
      Group2.prototype.checkFilled = function() {
        for (var _i = 0, _a = this.s.criteria; _i < _a.length; _i++) {
          var crit = _a[_i];
          if (crit.criteria instanceof Criteria && crit.criteria.s.filled || crit.criteria instanceof Group2 && crit.criteria.checkFilled()) {
            return true;
          }
        }
        return false;
      };
      Group2.prototype.count = function() {
        var count = 0;
        for (var _i = 0, _a = this.s.criteria; _i < _a.length; _i++) {
          var crit = _a[_i];
          if (crit.criteria instanceof Group2) {
      ...
      Group2.prototype._addPrevGroup = function(loadedGroup) {
        var idx = this.s.criteria.length;
        var group = new Group2(this.s.dt, this.c, this.s.topGroup, idx, true, this.s.depth + 1, this.s.serverData);
        this.s.criteria.push({
          criteria: group,
          index: idx,
          logic: group.s.logic
      ...
      Group2.prototype._addPrevCriteria = function(loadedCriteria) {
        var idx = this.s.criteria.length;
      ...
      Group2.prototype._andSearch = function(rowData, rowIdx) {
        if (this.s.criteria.length === 0) {
          return true;
        }
        for (var _i = 0, _a = this.s.criteria; _i < _a.length; _i++) {
      ...
      Group2.prototype._orSearch = function(rowData, rowIdx) {
        if (this.s.criteria.length === 0) {
          return true;
        }
        ...
        for (var _i = 0, _a = this.s.criteria; _i < _a.length; _i++) {
          ...
          } else if (crit.criteria instanceof Group2 && crit.criteria.checkFilled()) {
            filledfound = true;
            if (crit.criteria.search(rowData, rowIdx)) {
              return true;
            }
      ...
      Group2.prototype._removeCriteria = function(criteria, group) {
        if (group === void 0) {
          group = false;
        }
        if (this.s.criteria.length <= 1 && this.s.isChild) {
          ...
          var last = void 0;
          for (var i = 0; i < this.s.criteria.length; i++) {
            if (this.s.criteria[i].index === criteria.s.index && (!group || this.s.criteria[i].criteria instanceof Group2)) {
              last = i;
            }
          }
          if (last !== void 0) {
      ...
      Group2.prototype._setCriteriaListeners = function(criteria) {
        var _this = this;
        ...
        criteria.dom.right.unbind("click").on("click.dtsb", function() {
          ...
          var group = new Group2(_this.s.dt, _this.s.opts, _this.s.topGroup, criteria.s.index, true, _this.s.depth + 1, _this.s.serverData);
        ...
        criteria.dom.left.unbind("click").on("click.dtsb", function() {
          _this.s.toDrop = new Criteria(_this.s.dt, _this.s.opts, _this.s.topGroup, criteria.s.index, void 0, _this.s.serverData);
      ...
      Group2.prototype._setClearListener = function() {
        var _this = this;
      ...
      Group2.prototype._setGroupListeners = function(group) {
        var _this = this;
      ...
      Group2.prototype._setup = function() {
        this.setListeners();
      ...
      Group2.prototype._setLogicListener = function() {
        var _this = this;
      ...
      Group2.prototype._toggleLogic = function() {
        if (this.s.logic === "OR") {
          this.s.logic = "AND";
  ...
  var SearchBuilder = (
    /** @class */
    function() {
      function SearchBuilder2(builderSettings, opts) {
        var _this = this;
        if (!dataTable$1 || !dataTable$1.versionCheck || !dataTable$1.versionCheck("1.10.0")) {
          throw new Error("SearchBuilder requires DataTables 1.10 or newer");
        }
        var table = new dataTable$1.Api(builderSettings);
        this.classes = $$1.extend(true, {}, SearchBuilder2.classes);
        this.c = $$1.extend(true, {}, SearchBuilder2.defaults, opts);
        this.dom = {
        ...
        if (table.settings()[0]._searchBuilder !== void 0) {
          return;
        }
      ...
      SearchBuilder2.prototype.getDetails = function(deFormatDates) {
        if (deFormatDates === void 0) {
          deFormatDates = false;
        }
        return this.s.topGroup.getDetails(deFormatDates);
      };
      SearchBuilder2.prototype.getNode = function() {
        return this.dom.container;
      };
      SearchBuilder2.prototype.rebuild = function(details) {
      ...
      SearchBuilder2.prototype._applyPreDefDefaults = function(preDef) {
        var _this = this;
        if (preDef.criteria !== void 0 && preDef.logic === void 0) {
          preDef.logic = "AND";
        }
        var _loop_1 = function(crit2) {
          if (crit2.criteria !== void 0) {
            crit2 = this_1._applyPreDefDefaults(crit2);
          } else {
            this_1.s.dt.columns().every(function(index) {
              if (_this.s.dt.settings()[0].aoColumns[index].sTitle === crit2.data) {
                crit2.dataIdx = index;
              }
            });
          }
      ...
      SearchBuilder2.prototype._setUp = function(loadState) {
        var _this = this;
        if (loadState === void 0) {
          loadState = true;
        }
        $$1.fn.DataTable.Api.registerPlural("columns().type()", "column().type()", function() {
          return this.iterator("column", function(settings, column2) {
            return settings.aoColumns[column2].sType;
          }, 1);
        });
        if (!dataTable$1.DateTime) {
          var types = this.s.dt.columns().type().toArray();
          if (types === void 0 || types.includes(void 0) || types.includes(null)) {
            types = [];
            for (var _i = 0, _a = this.s.dt.settings()[0].aoColumns; _i < _a.length; _i++) {
              var colInit = _a[_i];
              types.push(colInit.searchBuilderType !== void 0 ? colInit.searchBuilderType : colInit.sType);
            }
          }
          ...
          for (var i = 0; i < columnIdxs[0].length; i++) {
            ...
            if (
              ...
              (this.c.columns === true || Array.isArray(this.c.columns) && this.c.columns.includes(i)) && // Check if the type is one of the restricted types
        ...
        this.s.topGroup = new Group(this.s.dt, this.c, void 0, void 0, void 0, void 0, this.s.serverData);
        this._setClearListener();
        ...
        if (loadState) {
          ...
          if (loadedState !== null && loadedState.searchBuilder !== void 0) {
      ...
      SearchBuilder2.prototype._collapseArray = function(criteria) {
        if (criteria.logic === void 0) {
          if (criteria.value !== void 0) {
      ...
      SearchBuilder2.prototype._updateTitle = function(count) {
        this.dom.title.html(this.s.dt.i18n("searchBuilder.title", this.c.i18n.title, count));
      };
      SearchBuilder2.prototype._build = function() {
        var _this = this;
      ...
      SearchBuilder2.prototype._checkClear = function() {
      ...
      SearchBuilder2.prototype._filterChanged = function(count) {
        var fn = this.c.filterChanged;
        if (typeof fn === "function") {
          fn(count, this.s.dt.i18n("searchBuilder.button", this.c.i18n.button, count));
        }
      };
      SearchBuilder2.prototype._setClearListener = function() {
        var _this = this;
        this.dom.clearAll.unbind("click");
        this.dom.clearAll.on("click.dtsb", function() {
          _this.s.topGroup = new Group(_this.s.dt, _this.c, void 0, void 0, void 0, void 0, _this.s.serverData);
          _this._build();
          _this.s.dt.draw();
      ...
      SearchBuilder2.prototype._setRedrawListener = function() {
        var _this = this;
      ...
      SearchBuilder2.prototype._setEmptyListener = function() {
        var _this = this;
      ...
      SearchBuilder2.version = "1.5.0";
      SearchBuilder2.classes = {
        button: "dtsb-button",
  ...
  jquery_dataTables_default.SearchBuilder = SearchBuilder;
  dataTable.SearchBuilder = SearchBuilder;
  jquery_dataTables_default.Group = Group;
  dataTable.Group = Group;
  jquery_dataTables_default.Criteria = Criteria;
  dataTable.Criteria = Criteria;
  var apiRegister = jquery_dataTables_default.Api.register;
  jquery_dataTables_default.ext.searchBuilder = {
    conditions: {}
  };
  jquery_dataTables_default.ext.buttons.searchBuilder = {
    ...
    init: function(dt, node, config) {
      var sb = new jquery_dataTables_default.SearchBuilder(dt, $.extend({
  ...
  function _init(settings, options) {
    ...
    var opts = options ? options : api.init().searchBuilder || jquery_dataTables_default.defaults.searchBuilder;
  ...
  $(document).on("preInit.dt.dtsp", function(e, settings) {
    ...
    if (settings.oInit.searchBuilder || jquery_dataTables_default.defaults.searchBuilder) {
  ...
  if (jquery_dataTables_default.ext.features) {
    jquery_dataTables_default.ext.features.register("searchBuilder", _init);
  }
})();

// node_modules/datatables.net-searchbuilder-dt/js/searchBuilder.dataTables.mjs
var searchBuilder_dataTables_default = dataTables_dataTables_default;
export {
  searchBuilder_dataTables_default as default
};
...
datatables.net-searchbuilder-dt/js/searchBuilder.dataTables.mjs:
   ...
   *)
*/
//# sourceMappingURL=datatables__net-searchbuilder-dt.js.map
