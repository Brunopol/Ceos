        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 text-gray-900 ">
                    ...
                    <table id="tableSolicitacoes" class="table table-striped nowrap cell-border hover stripe ">
                        <thead>
                            <tr>
                                <th>Criado em</th>
                                <th>Nome</th>
                        ...
                        <form id="updateUserForm">
                            ...
                            <div
                                ...
                                <div class="relative p-6 flex-auto grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <label for="ramal"
                                            class="block text-sm font-medium text-gray-700">Ramal</label>
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <div class="flex items-center space-x-2">
                                            <input type="checkbox" id="encaixeVisualizarCheckbox"
                                                name="permissions[]" class="form-checkbox" value="encaixeVisualizar">
